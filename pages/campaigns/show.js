...
class CampaignShow extends Component {
    static async getInitialProps(props) {
        /** we're going to define that get initial prop's method 
         * that function gets called automatically before our campaign 
         * gets render before a component is rendered to a screen*/
